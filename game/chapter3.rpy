label chapter3_full:
    ...
    a "iya kau benar…… hanya ruangan kosong"
    ...
    k "as-leen liat, ada beberapa roh data kecil"
    a "pengamatan yang sangat luar biasa…. darimana kau mempelajari itu wara?"
    ...
    play sound "audio/sfx/chapter 3/5.suara Floating petals sound.mp3"

    a "sungguh indah….."
    k "benar sekali……..setelah menghirup wangi ini aku menjadi tenang."
    ...
    k "ini bukan bunga biasa………ini seperti jalan untuk kita menuju tantangan selanjutnya"
    hide k_ talk
    ...
    show k_talk at Position(xalign=0.5, yalign=0.3) with fade
    k "(menunjuk atap)"
    k "disana…… disana adalah stage selanjutnya."
    k "kita harus menggunakan bunga ini untuk melompat as-leen."
    a "cepat….kita harus menuju stage selanjutnya"
    hide k_talk

    scene bg_c3_topang_asleen with fade
    nr "Wara pun mendekati As-leen dan mengangkat tubuhnya dengan bridal style."
    nr "As-leen terkejut, pipi yang lucu dan imut itu memerah."

    k "siap?.....ayo kita berangkat"
    a "aku sudah siap."
    ...
    nr "Ia melompat dari satu bunga ke bunga lainnya."
    nr "As-leen yang berada dalam dekapan wara itu pun mempererat pegangannya."
    nr "Wara menyadari itu. Lalu ia melihat As-leen dengan tatapan yang dalam ke matanya."

    k "gak usah takut…… ada aku disini."
    ...
    k "dan juga setiap mimpinya memiliki artinya masing masing"

    a "kau memang hebat bisa menahan semua rasa itu."
    a "tak banyak yang bisa bertahan wara…."

    k "aku tak tau pasti,"
    k "namun sebagian dari mereka ingin diingat oleh manusia manusia selanjutnya……."
    k "menurutku itu sangat menarik….."

    nr "\"sebuah keinginan untuk diingat\" adalah suatu hal yang membuat kreswara terkesan dengan itu."
    nr "Ia mengingat bahwa saat ia di bangku sekolah,"
    nr "ia melihat simbol-simbol dan menggambar di beberapa gua"
    nr "untuk menunjukkan dan memberitahu bahwa mereka bukan hanya dongeng."
    nr "Namun mereka nyata,"
    nr "dan mereka menggambarkan bagaimana kehidupan mereka berjalan."

    a "kreswara?.......apakah kau baik baik saja?"

    k "aku hanya sedang berpikir tentang sebuah tujuan hidup yang sedang aku jalani."
    k "dan apa yang akan aku lakukan setelah selesai mengerjakan ini semua lalu kembali ke dunia."
    ...
    nr "Hanya berlomba-lomba untuk meninggalkan jejak mereka di semua sudut bumi."
    nr "Dan untuk berteriak secara tak langsung ke seluruh penjuru buana"
    nr "bahwa mereka pernah hidup, mereka pernah berjuang, mereka pernah ada."

    k "jika aku kembali ke dunia sekali lagi."
    k "aku tak berharap semua orang mengingatnya."
    k "atau memperingati itu."
    k "tapi, aku ingin membuat sesuatu untuk orang yang paling aku cintai akan mengingatnya."
    k "dan itu kekal di dalam hati dan pikirannya."
    k "aku ingin mempersembahkan untuknya dalam bentuk barisan kode di layar,"
    k "kanvas yang tergores indah dengan kuas,"
    k "tangga nada yang tersusun rapih di tiap bait,"
    k "maupun kata kata indah yang digabungkan menjadi satu."
    k "aku ingin memberikan segalanya untuknya."

    nr "AS-LEEN terdiam cukup lama setelah mendengar semua ucapan wara."
    nr "tubuhnya masih berada di dalam dekapan wara saat mereka melompat dari satu bunga kamboja ke bunga lainnya."
    ...
    a "andai saja aku bisa memahami semua hal yang kamu rasakan itu…"
    a "tapi aku hanyalah AI."
    ...
    k "selama ini kamu selalu ada di samping aku,"
    k "denger semua cerita yang bahkan gak pernah berani aku bilang ke siapa siapa."
    k "kamu liat aku pas takut, pas capek, pas bingung sendiri sama hidup aku."
    k "dan anehnya… makin lama aku jalan sama kamu,"
    ...
    k "jadi tenang aja…"
    k "kamu udah jadi seseorang yang bakal terus abadi di dalam seluruh karya yang aku buat."
    k "dalam setiap game yang aku buat."
    ...
    nr "lorong tersebut terlalu sepi, terlalu aman,"
    ...
    scene bg_c3_jarum_retak with dissolve
    ...
    k "nah kan bener… aku juga tau dari awal gak mungkin tempat beginian bakal ngelepasin kita segampang itu!"
    k "(Sambil lari kencang bersama As-Leen)"

    ## [BG KHUSUS] — pintu semakin tertutup
    scene bg_c3_pintu_tutup_2 with dissolve

    nr "pintu besar itu perlahan mulai menutup."

    a "Waraa, lihat pintu itu mulai tertutup"
    ...
    play sound "audio/sfx/chapter 3/terjatuh.mp3"
    ...
    play music "audio/backsound/Chapter 3/1_Boss_Entrance.mp3" fadein 1.5
    ...
    sk "(Ketawa kejam)"
    sk "tentu saja. lucu rasanya melihat orang berpikir mereka sudah hampir menang,"
    ...
    sk "aku penasaran… seberapa lama manusia seperti dirimu bisa tetap tenang sebelum emosinya memakan dirinya sendiri?"
    k "aku gak dateng kesini buat denger omongan kosong kamu."
    sk "oh ya? tapi wajahmu gampang banget dibaca."
    sk "sedikit dipancing langsung marah. sedikit ditekan langsung panik. manusia memang lucu ya."
...
label boss_sengkuni_start:
    ...
    play music "audio/backsound/Chapter 3/2_Fase_1.mp3" fadein 1.0

    show screen radar_roh_screen(level=2)
    pause 1.0

    centered "── FASE 1: Kenali Jebakan Data ──"

    show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
    a "Wara, dia menyerang dengan data menjebak!"
    ...
    k "Baik. Aku tidak akan terpancing."
    hide k_angrytalk
...
label c3_soal_1:
    show screen soal_panel(
        nomor="1",
        tema="Python – Fungsi",
        kode="def hitung(a, b):\n    return ???\n\nprint(hitung(10, 7))  # Output: 17",
        pertanyaan="Manakah isi fungsi yang menghasilkan output 17\nsaat dipanggil dengan hitung(10, 7)?"
    )
    ...
    menu:
        ...
        "return a + b":
            ...
            hide k_angrytalk
            play sound "audio/backsound/Chapter 3/lordsonny-punch-a-rock-161647.mp3"
...
label c3_soal_1_cadangan:
    ...
    menu:
        "A":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), lompat_kaget with dissolve
            k "Nilai 75 tidak >= 85, jadi bukan A!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "Perhatikan kondisi pertama: 75 >= 85 itu False. Coba lagi!"
            hide a_talk
            jump c3_soal_1_cadangan
        ...
        "B":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), getar with dissolve
            k "B! 75 >= 70 itu benar, jadi elif pertama yang jalan!"
        ...
        "C":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), lompat_kaget with dissolve
            k "C itu untuk yang tidak memenuhi keduanya. 75 masih masuk elif!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "Cek lagi kondisi elif: 75 >= 70 itu benar! Perhatikan baik-baik!"
            hide a_talk
            jump c3_soal_1_cadangan
        ...
        "AB (dua baris)":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), lompat_kaget with dissolve
            k "if-elif hanya menjalankan SATU blok yang pertama kali benar!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "if-elif-else hanya menjalankan satu blok saja, Wara!"
            hide a_talk
            jump c3_soal_1_cadangan
...
label c3_soal_2_cadangan:
    ...
    menu:
        "Meningkatkan jumlah penduduk agar tenaga kerja melimpah":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), lompat_kaget with dissolve
            k "Salah! Justru sebaliknya, KB untuk mengurangi, bukan menambah!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "KB artinya mengendalikan pertumbuhan. Fokus, Wara!"
            hide a_talk
            jump c3_soal_2_cadangan
        ...
        "Mengendalikan laju pertumbuhan penduduk yang dinilai terlalu cepat":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), getar with dissolve
            k "Benar! Dua Anak Cukup — slogan KB yang berhasil menekan angka kelahiran!"
        ...
        "Memindahkan penduduk dari Jawa ke luar Jawa":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), lompat_kaget with dissolve
            k "Itu program Transmigrasi, bukan KB!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "KB dan Transmigrasi itu beda program! Fokus, Wara!"
            hide a_talk
            jump c3_soal_2_cadangan
        ...
        "Meningkatkan angka kelahiran di daerah terpencil":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), lompat_kaget with dissolve
            k "Kebalikannya! KB justru untuk mengurangi angka kelahiran!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "Arah programnya terbalik Wara. Baca soal lebih teliti!"
            hide a_talk
            jump c3_soal_2_cadangan
...
label boss_sengkuni_fase2:
    stop music fadeout 0.5
    play music "audio/backsound/Chapter 3/3_Fase_2_dan_3.mp3" fadein 1.0
    ...
    ## [BG KHUSUS] — Tidak tampilkan sprite karakter
    scene bg_c3_sengkuni_hantam with fade

    centered "── FASE 2: RAGE STATE — Sengkuni Mengamuk! ──"

    sk "belum sempat wara membalas, tiba tiba puluhan jarum tajam langsung muncul dari lantai arena mengarah ke tubuhnya."
    ...
    nr "wara langsung menyerang ke arah sengkuni, namun tiba tiba tubuh sengkuni menghilang menjadi serpihan data."

    k "HAHH?! APA APAAN INI???"
    ...
    nr "tendangan sengkuni langsung menghantam punggung wara sampai tubuhnya terpental beberapa meter."
    ...
    nr "namun kali ini ia mulai sadar sesuatu."
    nr "Semakin emosinya terpancing, semakin mudah sengkuni membaca gerakannya."

    ## [BG UMUM] — kembali ke bg umum untuk dialog dengan sprite
    scene bg_black_and_white with fade

    show k_angrytalk at Position(xalign=0.5, yalign=0.3) with dissolve
    k "Wara perlahan mengatur napas dan emosinya sambil menatap sengkuni dengan kesal."
    hide k_angrytalk

    show sk_talk at Position(xalign=0.5, yalign=0.2) with dissolve
    sk "nahh… itu dia wajah yang aku suka. makin marah, makin gampang ditebak."
    hide sk_talk

    show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
    a "Wara, jangan terpancing! Perhatikan polanya dulu sebelum menyerang!"
    hide a_talk
...
label c3_soal_3_cadangan:
    ...
    menu:
        "1 2 3 4 5":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), lompat_kaget with dissolve
            k "while berhenti saat n=5 karena 5 <= 4 itu False!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "Kondisi n <= 4 tidak terpenuhi saat n=5. Perhatikan batasnya!"
            hide a_talk
            jump c3_soal_3_cadangan
        ...
        "1 2 3 4":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), getar with dissolve
            k "1 2 3 4! While berhenti tepat saat n mencapai 5!"
            k "Aku bisa bangkit dari kesalahan, Sengkuni!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "Bagus! Kumpulkan fokus, Wara!"
            hide a_talk
            jump c3_soal_4
        ...
        "2 3 4 5":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), lompat_kaget with dissolve
            k "n mulai dari 1 dan berhenti di 4, bukan mulai dari 2!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "Perhatikan nilai awal n dan kondisi berhentinya!"
            hide a_talk
            jump c3_soal_3_cadangan
...
label c3_soal_4_cadangan:
    ...
    menu:
        "Meratakan persebaran penduduk yang terkonsentrasi di Pulau Jawa":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), getar with dissolve
            k "Benar! Transmigrasi memindahkan penduduk dari Jawa ke luar Jawa untuk pemerataan!"
        ...
        "Memperluas wilayah Indonesia ke pulau-pulau terpencil":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), lompat_kaget with dissolve
            k "Transmigrasi bukan soal memperluas wilayah!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "Fokus pada kata 'persebaran penduduk'!"
            hide a_talk
            jump c3_soal_4_cadangan
        ...
        "Mengembangkan sektor pariwisata di daerah tujuan":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), lompat_kaget with dissolve
            k "Bukan pariwisata, itu tujuan yang terlalu sempit!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "Transmigrasi itu soal perpindahan penduduk, Wara. Bukan pariwisata!"
            hide a_talk
            jump c3_soal_4_cadangan
        ...
        "Menciptakan pusat-pusat industri baru di luar Jawa":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), lompat_kaget with dissolve
            k "Industri bukan fokus utama transmigrasi!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "Transmigrasi tujuan utamanya pemerataan penduduk, bukan industri!"
            hide a_talk
            jump c3_soal_4_cadangan
...
label boss_sengkuni_fase3_retry:
    ...
    a "Kita masih bisa, Wara. Sengkuni sudah lemah—tinggal fase terakhir!"
...
label boss_sengkuni_fase3:
    ...
    show effect_3 at truecenter with fade
    pause 3.0

    ## [BG KHUSUS] — Tidak tampilkan sprite karakter
    scene bg_c3_wara_serang with fade

    centered "── FASE 3: ENRAGED MODE — Chaos Pressure! ──"

    sk "kali ini wara tidak langsung menyerang."
    sk "ia memilih diam sambil memperhatikan gerakan sengkuni pelan pelan."
    ...
    k "(dalam hati)"
    k "jadi itu caranya… dia bukan benar benar menghilang."
    k "dia cuma pindah posisi lewat data"
    ...
    k "udah selesai main jebak jebakannya?"

    ## [BG UMUM] — kembali ke bg umum untuk dialog soal
    scene bg_black_and_white with fade
...
label c3_soal_5_cadangan:
    ...
    menu:
        "Besar":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), lompat_kaget with dissolve
            k "x=10, tidak memenuhi x > 15! Jadi bukan Besar!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "10 > 15 itu False! Perhatikan kondisi dalam if bersarang!"
            hide a_talk
            jump c3_soal_5_cadangan
        ...
        "Sedang":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), getar with dissolve
            k "Sedang! x=10 memenuhi x>5, tapi tidak x>15, jadi masuk else dalam!"
        ...
        "Kecil":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), lompat_kaget with dissolve
            k "x=10 memenuhi x>5, jadi tidak masuk else luar!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "Perhatikan: kondisi pertama x>5 itu True! Masuk if luar dulu!"
            hide a_talk
            jump c3_soal_5_cadangan
        ...
        "Besar Sedang":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), lompat_kaget with dissolve
            k "if-else hanya menjalankan SATU blok, tidak dua sekaligus!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "if-else pilih salah satu saja, Wara!"
            hide a_talk
            jump c3_soal_5_cadangan
...
label c3_soal_6_cadangan:
    ...
    menu:
        "2, 5, 8, 11":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), lompat_kaget with dissolve
            k "11 sudah melewati batas 10! range tidak termasuk nilai stop!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "range(start, stop, step) — nilai stop tidak termasuk!"
            hide a_talk
            jump c3_soal_6_cadangan
        ...
        "2, 5, 8":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), getar with dissolve
            k "2, 5, 8! Mulai dari 2, tambah 3, berhenti sebelum 10!"
        ...
        "3, 6, 9":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), lompat_kaget with dissolve
            k "Mulai dari 2, bukan 3!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "start = 2, bukan 3! Perhatikan argumen pertama range!"
            hide a_talk
            jump c3_soal_6_cadangan
        ...
        "2, 4, 6, 8":
            ...
            hide screen feedback_screen
            show k_angrytalk at Position(xalign=0.5, yalign=0.3), lompat_kaget with dissolve
            k "step-nya 3, bukan 2! Itu beda range!"
            hide k_angrytalk
            show a_talk at Position(xalign=0.5, yalign=0.3) with dissolve
            a "range(2,10,3) berarti tambah 3 setiap langkah, bukan 2!"
            hide a_talk
            jump c3_soal_6_cadangan
...
label boss_sengkuni_menang:
    ...
    ## [BG KHUSUS] — Serangan final, tidak tampilkan sprite
    scene bg_c3_wara_serang with fade
    play sound "audio/backsound/Chapter 3/nastelbom-intense-453507.mp3"

    k "wara kembali meluncurkan serangan terakhirnya tepat ke inti tubuh sengkuni."
    ...
    ## [BG KHUSUS] — Sengkuni kalah, tidak tampilkan sprite
    scene bg_c3_sengkuni_kalah with fade

    nr "tubuh sengkuni langsung hancur menjadi serpihan ungu yang perlahan menghilang dari arena."
    nr "arena akhirnya kembali sunyi setelah tubuh sengkuni hancur menjadi serpihan data."

    stop sound fadeout 1.0
    play music "audio/backsound/Chapter 3/(5) ASLEEN_TERKENA_RACUN__ENDING_DIGENDONG.mp3" fadein 2.0

    k "huhhh, akhirnya selesai juga…"

    ## ── Jebakan Terakhir Sengkuni: Racun ─────────────────────
    ## [BG KHUSUS] — As-leen terkena racun, tidak tampilkan sprite
    scene bg_c3_asleen_racun with fade
    ...
    k "udah, sini naik aja."
    k "aku gak mau kondisi kamu makin parah gara gara dipaksa jalan sendiri."

    a "baiklah."

    ## [BG KHUSUS] — wara gendong as-leen, tidak tampilkan sprite
    scene bg_c3_gendong with fade
...
label chapter3_ending:
    ...
    ## [BG UMUM] — Ending, bisa tampilkan sprite
    scene bg_black_and_white with fade
    play music "audio/backsound/Chapter 3/paulyudin-romantic-dreams-155789.mp3" fadein 2.0

    centered "── CHAPTER 3 SELESAI ──"
    centered "\"Jebakan di Balik Ketenangan\""

    show k_talk at Position(xalign=0.5, yalign=0.3) with fade
    k "AS-LEEN terluka. Perjalanan ini semakin berat…"
    k "tapi aku tidak akan berhenti."
    k "Aku akan menemukan bunga anggrek itu dan menyelamatkannya."
    hide k_talk

    centered "AS-LEEN terluka. Perjalanan Kreswara semakin berat."
    centered "Boss berikutnya: Duryodana — Penguasa Terakhir Dunia Hybrid."
    centered "Sampai jumpa di Chapter 4: Master Sejati."
